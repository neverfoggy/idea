        ...
        <div id="carouselExampleControls1" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="row">
                        <div class="col-4">
                            <img class="d-block w-100 pt-1 pb-1" src="logo_train.png" alt="First slide" style="height: 110px;">
                        </div>
                        <div class="col-4">
                            <img class="d-block w-100 img-fluid pt-4" src="logo_kolyadichi.png" alt="Second slide" style="height: 70px;">
                        </div>
                        <div class="col-4">
                            <img class="d-block w-100 img-fluid pt-3 pb-3" src="plastic.png" alt="Second slide" style="height: 100px;">
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="row">
                        <div class="col-4 ">
                            <img class="d-block w-100 img-fluid pt-4 " src="ekstra.png" alt="Second slide" style="height: 80px;">
                        </div>
                        <div class="col-4">
                            <img class="d-block w-100 img-fluid pt-3 pb-2" src="logo_dolya.png" alt="Second slide" style="height: 100px;">
                        </div>
                        <div class="col-4 " style="padding-bottom: 10px">
                            <img class="d-block w-75 " src="master.png" alt="Second slide" style="height: 100px;">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="wrapper2 pb-5">
    ...
    <div id="carouselExampleIndicators" class="carousel slide shadow mx-auto" data-ride="carousel" style="max-width:915px;">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="sklad1.jpg" class="d-block w-100" alt="...">
            ...
            <div class="carousel-item" >
                <img src="sklad2.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block pb-9  ">
                    <div class="d-flex justify-content-start">
            ...
            <div class="carousel-item" >
                <img src="sklad3.jpg" class="d-block w-100"  alt="...">
                <div class="carousel-caption d-none d-md-block pb-9  ">
                    <div class="d-flex justify-content-start">
            ...
            <div class="carousel-item" >
                <img src="sklad4.jpg" class="d-block w-100"  alt="...">
                <div class="carousel-caption d-none d-md-block pb-9  ">
                    <div class="d-flex justify-content-start">
    ...
    <div class="container2 ">
        <form name="loginForm" method="POST" action="controller">
            ...
            <div class="row ">
                <div class="input-group ">
                    <div class="col-sm-5 col-lg-5">
                        <input type="text" class="form-control" placeholder="Ваш телефон " name="number" value=""/>
                        <br/>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-start">
                <div class="col-lg-5">
                    <div class="input-group mt-2">
                        <button class="btn btn-dark  " type="submit" value="send">Отправить</button>
                    </div>
